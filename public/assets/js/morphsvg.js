...
!function (t, e) {
    ...
    function convertToPath(t, e) {
        var n, r, o, i, a, h, s, l, g, c, f, p, u, d, P, _, w, m, v, y, x, M, T = t.tagName.toLowerCase(),
            b = .552284749831;
        return "path" !== T && t.getBBox ? (h = function _createPath(t, e) {
            ...
            return r
        }(t, R[T]), "rect" === T ? (i = M.rx, a = M.ry || i, r = M.x, o = M.y, c = M.width - 2 * i, f = M.height - 2 * a, n = i || a ? "M" + (_ = (d = (u = r + i) + c) + i) + "," + (m = o + a) + " V" + (v = m + f) + " C" + [_, y = v + a * b, P = d + i * b, x = v + a, d, x, d - (d - u) / 3, x, u + (d - u) / 3, x, u, x, p = r + i * (1 - b), x, r, y, r, v, r, v - (v - m) / 3, r, m + (v - m) / 3, r, m, r, w = o + a * (1 - b), p, o, u, o, u + (d - u) / 3, o, d - (d - u) / 3, o, d, o, P, o, _, w, _, m].join(",") + "z" : "M" + (r + c) + "," + o + " v" + f + " h" + -c + " v" + -f + " h" + c + "z") : "circle" === T || "ellipse" === T ? (l = "circle" === T ? (i = a = M.r) * b : (i = M.rx, (a = M.ry) * b), n = "M" + ((r = M.cx) + i) + "," + (o = M.cy) + " C" + [r + i, o + l, r + (s = i * b), o + a, r, o + a, r - s, o + a, r - i, o + l, r - i, o, r - i, o - l, r - s, o - a, r, o - a, r + s, o - a, r + i, o - l, r + i, o].join(",") + "z") : "line" === T ? n = "M" + M.x1 + "," + M.y1 + " L" + M.x2 + "," + M.y2 : "polyline" !== T && "polygon" !== T || (n = "M" + (r = (g = (t.getAttribute("points") + "").match(N) || []).shift()) + "," + (o = g.shift()) + " L" + g.join(","), "polygon" === T && (n += "," + r + "," + o + "z")), h.setAttribute("d", rawPathToString(h._gsRawPath = stringToRawPath(n))), e && t.parentNode && (t.parentNode.insertBefore(h, t), t.parentNode.removeChild(t)), h) : t
    }
    ...
    function stringToRawPath(t) {
        ...
        var e, n, r, o, i, a, h, s, l, g, c, f, p, u, d, P = (t + "").replace(A, function (t) {
                var e = +t;
        ...
        for (e = 0; e < v; e++)
            if (p = i, isNaN(P[e]) ? a = (i = P[e].toUpperCase()) !== P[e] : e--, r = +P[e + 1], o = +P[e + 2], a && (r += w, o += m), e || (s = r, l = o), "M" === i) h && (h.length < 8 ? --_.length : y += h.length), w = s = r, m = l = o, h = [r, o], _.push(h), e += 2, i = "L";
            ...
            else if ("L" === i || "Z" === i) "Z" === i && (r = s, o = l, h.closed = !0), ("L" === i || .5 < Q(w - r) || .5 < Q(m - o)) && (yc(w, m, r, o), "L" === i && (e += 2)), w = r, m = o;
            else if ("A" === i) {
                if (u = P[e + 4], d = P[e + 5], g = P[e + 6], c = P[e + 7], n = 7, 1 < u.length && (u.length < 3 ? (c = g, g = d, n--) : (c = d, g = u.substr(2), n -= 2), d = u.charAt(1), u = u.charAt(0)), f = arcToSegment(w, m, +P[e + 1], +P[e + 2], +P[e + 3], +u, +d, (a ? w : 0) + 1 * g, (a ? m : 0) + 1 * c), e += n, f)
    ...
    function U(t, e) {
        ...
        for (var n, r, o, i, a, h, s, l, g, c, f, p, u, d, P, _, w = t.length, m = t[0][0], v = m, y = t[0][1], x = y, M = 1 / e; -1 < --w;)
            for (n = (a = t[w]).length, i = 6; i < n; i += 6)
                for (g = a[i], c = a[i + 1], f = a[i + 2] - g, d = a[i + 3] - c, p = a[i + 4] - g, P = a[i + 5] - c, u = a[i + 6] - g, _ = a[i + 7] - c, h = e; -1 < --h;) m < (r = ((s = M * h) * s * u + 3 * (l = 1 - s) * (s * p + l * f)) * s + g) ? m = r : r < v && (v = r), y < (o = (s * s * _ + 3 * l * (s * P + l * d)) * s + c) ? y = o : o < x && (x = o);
    ...
    function Z(t, e, n) {
        ...
        if (n)
            for (reverseSegment(r = t.slice(0)), i = 6; i < a; i += 6) (o = Y(r, e, i / 6, l, g)) < c && (c = o, f = -i);
        return f / 6
    }

    function $(t, e, n) {
        for (var r, o, i, a, h, s, l = t.length, g = 1e20, c = 0, f = 0; -1 < --l;)
            for (s = (r = t[l]).length, h = 0; h < s; h += 6) o = r[h] - e, i = r[h + 1] - n, (a = w(o * o + i * i)) < g && (g = a, c = r[h], f = r[h + 1]);
        return [c, f]
    }
    ...
    function aa(t, e) {
        var n, r, o, i, a, h, s, l, g, c, f, p, u, d, P = 0,
            _ = t.length,
            w = e / ((_ - 2) / 6);
        for (u = 2; u < _; u += 6)
            for (P += w; .999999 < P;) n = t[u - 2], r = t[u - 1], o = t[u], i = t[u + 1], a = t[u + 2], h = t[u + 3], s = t[u + 4], l = t[u + 5], g = n + (o - n) * (d = 1 / ((Math.floor(P) || 1) + 1)), g += ((f = o + (a - o) * d) - g) * d, f += (a + (s - a) * d - f) * d, c = r + (i - r) * d, c += ((p = i + (h - i) * d) - c) * d, p += (h + (l - h) * d - p) * d, t.splice(u, 4, n + (o - n) * d, r + (i - r) * d, g, c, g + (f - g) * d, c + (p - c) * d, f, p, a + (s - a) * d, h + (l - h) * d), u += 6, _ += 6, P--;
        return t
    }

    function ba(t, e, n, r, o) {
        var i, a, h, s, l, g, c, f = e.length - t.length,
            p = 0 < f ? e : t,
            u = 0 < f ? t : e,
            d = 0,
            P = "complexity" === r ? V : W,
            ...
            x = "log" === n;
        if (u[0]) {
            if (1 < p.length && (t.sort(P), e.sort(P), p.size || U(p), u.size || U(u), g = p.centerX - u.centerX, c = p.centerY - u.centerY, P === W))
                for (m = 0; m < u.length; m++) p.splice(m, 0, _(u[m], p, m, w, g, c));
            if (f)
                for (f < 0 && (f = -f), p[0].length > u[0].length && aa(u[0], (p[0].length - u[0].length) / 6 | 0), m = u.length; d < f;) p[m].size || T(p[m]), s = (h = $(u, p[m].centerX, p[m].centerY))[0], l = h[1], u[m++] = [s, l, s, l, s, l, s, l], u.totalPoints += 8, d++;
            for (m = 0; m < t.length; m++) i = e[m], a = t[m], (f = i.length - a.length) < 0 ? aa(i, -f / 6 | 0) : 0 < f && aa(a, f / 6 | 0), y && !1 !== o && !a.reversed && reverseSegment(a), (n = v[m] || 0 === v[m] ? v[m] : "auto") && (a.closed || Math.abs(a[0] - a[a.length - 2]) < .5 && Math.abs(a[1] - a[a.length - 1]) < .5 ? "auto" === n || "log" === n ? (v[m] = n = Z(a, i, !m || !1 === o), n < 0 && (y = !0, reverseSegment(a), n = -n), X(a, 6 * n)) : "reverse" !== n && (m && n < 0 && reverseSegment(a), X(a, 6 * (n < 0 ? -n : n))) : !y && ("auto" === n && Math.abs(i[0] - a[0]) + Math.abs(i[1] - a[1]) + Math.abs(i[i.length - 2] - a[a.length - 2]) + Math.abs(i[i.length - 1] - a[a.length - 1]) > Math.abs(i[0] - a[a.length - 2]) + Math.abs(i[1] - a[a.length - 1]) + Math.abs(i[i.length - 2] - a[0]) + Math.abs(i[i.length - 1] - a[1]) || n % 2) ? (reverseSegment(a), v[m] = -1, y = !0) : "auto" === n ? v[m] = 0 : "reverse" === n && (v[m] = -1), a.closed !== i.closed && (a.closed = i.closed = !1));
    ...
    function ea(t, e) {
        ...
        for (n = .5 * e / (.5 * (o = t.length) - 1), r = 0; r < o - 2; r += 2) {
            if (l += n, h = parseFloat(t[r + 2]), s = parseFloat(t[r + 3]), .999999 < l)
                for (a = 1 / (Math.floor(l) + 1), i = 1; .999999 < l;) f += (g + (h - g) * a * i).toFixed(2) + "," + (c + (s - c) * a * i).toFixed(2) + " ", l--, i++;
            f += h + "," + s + " ", g = h, c = s
        }
        return f
    }
    ...
    function ia(t, e) {
        for (var n, r, o, i, a, h, s, l, g, c, f, p, u = t.length, d = .2 * (e || 1); -1 < --u;) {
            for (f = (r = t[u]).isSmooth = r.isSmooth || [0, 0, 0, 0], p = r.smoothData = r.smoothData || [0, 0, 0, 0], f.length = 4, l = r.length - 2, s = 6; s < l; s += 6) o = r[s] - r[s - 2], i = r[s + 1] - r[s - 1], a = r[s + 2] - r[s], h = r[s + 3] - r[s + 1], g = v(i, o), c = v(h, a), (n = Math.abs(g - c) < d) && (p[s - 2] = g, p[s + 2] = c, p[s - 1] = w(o * o + i * i), p[s + 3] = w(a * a + h * h)), f.push(n, n, 0, 0, n, n);
            r[l] === r[0] && r[1 + l] === r[1] && (o = r[0] - r[l - 2], i = r[1] - r[l - 1], a = r[2] - r[0], h = r[3] - r[1], g = v(i, o), c = v(h, a), Math.abs(g - c) < d && (p[l - 2] = g, p[2] = c, p[l - 1] = w(o * o + i * i), p[3] = w(a * a + h * h), f[l - 2] = f[l - 1] = !0))
        }
        return t
    }
    ...
    function ma(t, e, n, r) {
        ...
        }(o = v(l, s) - c), !r && F && Math.abs(i + F.ca) < u && (r = F), this._anchorPT = F = {
    ...
    var n, j, F, I, o, v = Math.atan2,
        ...
        K = {
            ...
            init: function init(t, e, n, r, o) {
                ...
                }(e.shape || e.d || e.points || "", "d" === a, t), l && q.test(s)) return M("A <" + i + "> cannot accept path data. " + B), !1;
                if (g = e.shapeIndex || 0 === e.shapeIndex ? e.shapeIndex : "auto", c = e.map || K.defaultMap, this._prop = e.prop, this._render = e.render || K.defaultRender, this._apply = "updateTarget" in e ? e.updateTarget : K.defaultUpdateTarget, this._rnd = Math.pow(10, isNaN(e.precision) ? 2 : +e.precision), this._tween = n, s) {
                    if (this._target = t, y = "object" == typeof e.precompile, u = this._prop ? t[this._prop] : t.getAttribute(a), this._prop || t.getAttributeNS(null, "data-original") || t.setAttributeNS(null, "data-original", u), "d" === a || this._prop) {
                        ...
                        for ("log" !== e.precompile && !0 !== e.precompile || M('precompile:["' + rawPathToString(u) + '","' + rawPathToString(d) + '"]'), (S = "linear" !== (e.type || K.defaultType)) && (u = ia(u, e.smoothTolerance), d = ia(d, e.smoothTolerance), u.size || U(u), d.size || U(d), b = ja(C[0]), this._origin = u.origin = {
                            ...
                            for (m = u[_], v = d[_], f = m.isSmooth || [], p = v.isSmooth || [], w = m.length, P = F = 0; P < w; P += 2) v[P] === m[P] && v[P + 1] === m[P + 1] || (S ? f[P] && p[P] ? (x = m.smoothData, T = v.smoothData, N = P + (P === w - 4 ? 7 - w : 5), this._controlPT = {
                                ...
                                l2s: x[N],
                                l2c: T[N] - x[N]
                            }, h = this._tweenRotation(m, v, P + 2), this._tweenRotation(m, v, P, h), this._tweenRotation(m, v, N - 1, h), P += 4) : this._tweenRotation(m, v, P) : (h = this.add(m, P, m[P], v[P]), h = this.add(m, P + 1, m[P + 1], v[P + 1]) || h))
            ...
            render: function render(t, e) {
                ...
                if (1 === t && e._apply)
                    for (m = e._pt; m;) m.end && (e._prop ? w[e._prop] = m.end : w.setAttribute(m.endProp, m.end)), m = m._next;
                else if (u) {
                    for (; P;) a = P.sa + t * P.ca, i = P.sl + t * P.cl, P.t[P.i] = e._origin.x + x(a) * i, P.t[P.i + 1] = e._origin.y + O(a) * i, P = P._next;
                    for (r = t < .5 ? 2 * t * t : (4 - 2 * t) * t - 1; d;) p = (h = d.i) + (h === (o = u[d.j]).length - 4 ? 7 - o.length : 5), a = v(o[p] - o[h + 1], o[p - 1] - o[h]), c = O(a), f = x(a), l = o[h + 2], g = o[h + 3], i = d.l1s + r * d.l1c, o[h] = l - f * i, o[h + 1] = g - c * i, i = d.l2s + r * d.l2c, o[p - 1] = l + f * i, o[p] = g + c * i, d = d._next;
                    if (w._gsRawPath = u, e._apply) {
                        for (n = "", s = 0; s < u.length; s++)
                            for (i = (o = u[s]).length, n += "M" + (o[0] * _ | 0) / _ + " " + (o[1] * _ | 0) / _ + " C", h = 2; h < i; h++) n += (o[h] * _ | 0) / _ + " ";
