<div class="padding-item col-lg-12 col-md-12 col-sm-12" onclick="window.location='{{ route('single_course' , $course->slug) }}'">
    <div class="inner-div search-result">
        <div class=" prerequisite-items col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="row">
                <div class="padding-item  col-lg-3 col-md-6 col-sm-12 col-12">
                    <div class="image-box">
                        <img src="{{ Voyager::image($course->image) }}">
                    </div>
                </div>
                <div class="padding-item col-lg-4 col-md-6 col-sm-12 col-12">
                    <h3 >
                        {{ $course->title }}
                    </h3>
{{--                    <h6>--}}
...
{{--                    </h6>--}}
                ...
                <div class="see-row flex-box padding-item col-lg-5  col-md-12 col-sm-12 col-12">
