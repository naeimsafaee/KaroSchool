<div class="padding-item col-lg-12 col-md-12 col-sm-12 col-12">
    <div class="line color-full-line peper-line"></div>
</div>
<div class=" prerequisite-items col-lg-12 col-md-12 col-sm-12 col-12">
    <div class="row">
        <div class="padding-item  col-lg-3 col-md-3 col-sm-12 col-12">
            <div class="image-box">
                <img src="{{ Voyager::image($course->image) }}">
            </div>
        </div>
        <div class="padding-item col-lg-4 col-md-3 col-sm-12 col-12">
            <h3>
                {{ $course->title }}
            </h3>
            <div class="new-name motion">
                قدم اول یادگیری
            </div>
        </div>
